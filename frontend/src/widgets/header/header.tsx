...
const Header = () => {
  return (
    <header className="flex justify-between items-center bg-[#5E616A] dark:bg-[#283149] h-20 w-full p-5 top-0 bg-opacity-80 backdrop-blur-sm col-start-1 col-end-8 fixed">
